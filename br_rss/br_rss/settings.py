"""
Django settings for br_rss project.
...
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=list()) + ['localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'br_rss.wsgi.application'
